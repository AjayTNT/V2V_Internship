        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <h3 class="mb-0">Customer Complaints</h3>
                        </div>
                       <div class="col-sm-4 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#enquiryModal">
                                Complaint
                            </button>
                           <a href="./complain.php"> <button type="button" class="btn btn-success">
                                Refresh
                            </button></a>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="enquiryModal" tabindex="-1" aria-labelledby="enquiryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="submit_complaint.php" method="POST" class="ajax-form">
                    <div class="modal-header">
                        <h5 class="modal-title" id="enquiryModalLabel">Complaint</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="phone" class="form-label">Order ID/Bill No:</label>
                            <input type="number" id="order_id" name="order_id" class="form-control" required
                                placeholder="Enter your order id or bill no">
                        </div>

                        <div class="mb-3">
                            <label for="issue" class="form-label">Describe the issue:</label>
                            <textarea id="issue" name="issue" rows="4" class="form-control" required
