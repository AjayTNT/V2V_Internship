  ...
  <table id="dataTable" class="table table-bordered display">
    ...
    <footer class="app-footer text-center">
      <strong>
        ...
        <a href="https://adminlte.io" class="text-decoration-none">Ikea Furniture</a>.
      </strong>
      All rights reserved.
      <!--end::Copyright-->
    </footer>
  ...
  <div class="modal fade" id="enquiryModal" tabindex="-1" aria-labelledby="enquiryModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="submit_enquiry.php" method="POST" class="ajax-form">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label for="product" class="form-label">Furniture Type:</label>
            ...
            <div class="mb-3">
              ...
              <textarea id="message" name="message" rows="4" class="form-control" required
                placeholder="Enter your enquiry details"></textarea>
            </div>
          </div>
