                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-4 text-end">
                                ...
                                <a href="./feedback.php"><button type="button" class="btn btn-success">
                                        Refresh
                                </button></a>
                        </div>
                    </div>
   ...
   <div class="modal fade" id="enquiryModal" tabindex="-1" aria-labelledby="enquiryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="submit_feedback.php" method="POST" class="ajax-form">
                    <div class="modal-header">
                        <h5 class="modal-title" id="enquiryModalLabel">Feedback</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="comments" name="comments" rows="4" class="form-control" required
