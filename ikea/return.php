                            ...
                            <li class="user-header text-bg-primary">
                                ...
                                <p>
                                   <?php echo $_SESSION['username']." - ".$_SESSION['role']; ?>
                                    <small>Member since <?php echo $_SESSION['joiningDate']; ?></small>
                                </p>
                            </li>
                            <!--end::User Image-->
                            <!--begin::Menu Body-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="../index.html" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">Ikea Furniture</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                         ...
                         <div class="col-sm-4 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#enquiryModal">Return</button>
                            <a href="./return.php"><button type="button" class="btn btn-success">Refresh</button></a>
                        </div>
                    </div>
                    <!--end::Row-->
                </div>
            ...
            <div class="app-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-4">
                             <div class="container-flued p-1" style="overflow:auto;max-height:685px;">
      ...
      <?php } ?>
        ...
        <footer class="app-footer text-center">
            <strong>
                ...
                <a href="#" class="text-decoration-none">Ikea Furniture</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer>
    ...
    <div class="modal fade" id="enquiryModal" tabindex="-1" aria-labelledby="enquiryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="submit_return.php" method="POST" class="ajax-form">
                    <div class="modal-header">
                        <h5 class="modal-title" id="enquiryModalLabel">Return Request</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="phone" class="form-label">Order Id:</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="message" name="details" rows="4" class="form-control" required
